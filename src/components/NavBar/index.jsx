        ...
        <div className="cabeza">
          <nav className="navbar navbar-expand-lg navbar-light">
            <div className="container-fluid flexxxx">
                <div className="div1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-controller animate__animated animate__zoomInUp" viewBox="0 0 16 16">
                    ...
                    <Link to='/' ><h1 className="titulo animate__animated animate__zoomInUp">VENTA GAMER</h1></Link>
                </div>
